...
public class BusSearchingApi {
    ...
    public CtbEstTimeResponseDto loadEstTimeDto(@PathVariable("origStopId") String origStopId, @PathVariable("routeId") String routeId, @PathVariable("direction") String direction, @PathVariable("destStop") String destStop) {
